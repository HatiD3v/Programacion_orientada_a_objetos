...
✅ Setter: el set es muy similar a un método este permite modificar datos privados mediante validaciones/condiciones para mantener un control y asi evitar errores. En resumen GET obtiene el valor del dato privado y SET configura ese dato privado de manera controlada.
